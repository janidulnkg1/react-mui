...
export const MuiTextField = () => {
  ...
  return (
    <Stack spacing={4}>
        ...
        <Stack direction='row' spacing={2}>
            <TextField label='Username' required value={value} onChange={e => setValue(e.target.value)} error={!value} helperText={!value ? 'Required': 'Do not share your username with anyone!'}/>
